...
-- Q.4 Write a SQL query to find the averahge age of customers who purchased items from the 'Beauty' category.
...
SELECT category, gender, COUNT(transactions_id) AS total_number_of_transactions
FROM retail_sales
...
-- Q.9 Write a SQL query to find the number of unique customers who purchases items from each category.
SELECT category, 
